      ...
      <div class="table">
        <el-table :data="tableData" height="642" style="width: 100%">
          ...
          <el-table-column min-width="100px">
            ...
            <template slot-scope="scope">
              <p class="tableRow-text">{{ scope.row.selfEvaluation }}</p>
            </template>
          </el-table-column>
          <el-table-column min-width="100px">
            <template slot="header" slot-scope="scope">
            ...
            <template slot-scope="scope">
              <p class="tableRow-text">{{ scope.row.extracurricularStudy }}</p>
            </template>
          </el-table-column>
          <el-table-column min-width="100px">
            <template slot="header" slot-scope="scope">
            ...
            <template slot-scope="scope">
              <p class="tableRow-text">{{ scope.row.readingCategory }}</p>
            </template>
          </el-table-column>
          <el-table-column min-width="100px">
            <template slot="header" slot-scope="scope">
            ...
            <template slot-scope="scope">
              <p class="tableRow-text">{{ scope.row.sportHobby }}</p>
            </template>
          </el-table-column>
          <el-table-column min-width="100px">
            <template slot="header" slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    initList() {
      ...
      this.loading = true;
      this.$store
        .dispatch("students/getStudentList", {
    ...
    toDetail(info) {
      ...
      this.$router.push({
        path: "/index/students/studentsDetail",
        query: {
          id: info.userId,
        },
      });
